    ...
    <div class="row">
        <div class="col-4 sm-top" style="top:28px; cursor: pointer;">
            <a href="{{route('deposit.deposit')}}" class="d-flex flex-column justify-content-center align-items-center" style="text-decoration: none;">
                <i class="icofont-money p-3 fs-45 fs-sm-20 shadow-lg bg-white" style="border-radius: 50%;color: grey"></i>
            </a>
        ...
        <div class="col-4 sm-top" style="top:28px; cursor: pointer;">
            <a href="{{route('withdraw.manual_methods')}}" class="d-flex flex-column justify-content-center align-items-center" style="text-decoration: none;">
                <i class="icofont-location-arrow p-3 fs-45 fs-sm-20 shadow-lg bg-white" style="border-radius: 50%;color: grey"></i>
            </a>
        ...
        <div class="col-4 sm-top" style="top:28px; cursor: pointer;">
            <a href="{{route('transfer.wire_transfer')}}" class="d-flex flex-column justify-content-center align-items-center" style="text-decoration: none;">
                <i class="icofont-bank-transfer p-3 fs-45 fs-sm-20 shadow-lg bg-white" style="border-radius: 50%;color: grey"></i>
            </a>
       ...
       <div class="row p-2">
           <div class="col-md-6">
               <div class="form-group">
                   ...
                   <input type="text" class="form-control" name="account_number" value="{{ Auth::user()->account_number }}" readonly/>
               </div>
           </div>
                ...
                <div class="d-flex" style="justify-content: space-between;">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu mr-5" aria-labelledby="Accoutndropdown">
                            <a class="dropdown-item" data-toggle="modal" data-target="#exampleModalCenter" role="button">Full Account</a>
